  ...
  return (
    <>
      <button
        ...
        className="group flex w-full items-center gap-5 border-b border-edge/40 px-2 py-5 text-left transition-colors duration-150 last:border-b-0 hover:bg-surface/30 disabled:cursor-default"
      >
        ...
        <a
          ...
          className="shrink-0 text-faint opacity-0 transition-all duration-150 hover:text-content group-hover:opacity-100"
        >
          <svg
            viewBox="0 0 24 24"
